...
import { newGame, createClues } from './helpers';
...
export default class App extends Component {
	...
	handleSelectClick = (clueId, clueTeam, isAssassin) => {
		console.log(this.state.spymasterView);
    ...
    render(){
    	const {spymasterView} = this.state
		return (
			<div className="App">
				<GameDashboard
				...
				<div className="bottomDashboard">
					<Button toggle active={spymasterView} onClick={this.handleViewToggle} disabled={!this.state.gameActive}>
						Spymaster
					</Button>
